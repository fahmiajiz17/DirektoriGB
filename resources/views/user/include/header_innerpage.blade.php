...
<header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="{{ route('user.dashboard_user') }}">Direktori GB</a></h1>

        <nav id="navbar" class="navbar">
            <ul>
                <li><a class="nav-link scrollto" href="{{ route('user.dashboard_user') }}">Home</a></li>
                <li><a class="nav-link scrollto" href="{{ route('user.dashboard_user') }}">Data</a></li>
